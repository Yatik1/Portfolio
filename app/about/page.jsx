...
import { ArrowLeft, Ellipsis, House } from 'lucide-react';
  ...
  return (
    <div className="bg-[#FCFDF6] w-full h-screen flex items-center justify-center relative">
      ...
      <div className="relative w-fit bg-black rounded-full flex items-center justify-start p-2 gap-1">
        ...
        {!open && (
          <div
            className="flex items-center justify-center w-10 h-10 overflow-hidden bg-green-500 rounded-full text-white cursor-pointer hover:animate-spin"
